!function (e) {
    if ("object" == typeof exports) {
        ...
        "undefined" != typeof window ? f = window :
                "undefined" != typeof global ? f = global : "undefined" != typeof self && (f = self), f.irf = e()
    }
}(function () {
    ...
    return (function e(t, n, r) {
        ...
        BoundingBox = (function () {
            ...
            BoundingBox.prototype.render = function (ctx) {
                ...
                return ctx.strokeRect(this.coor.x - this.dim.x / 2, this.coor.y - this.dim.y / 2, this.dim.x,
                    this.dim.y);
            };
            ...
            DataSource.prototype.readImage = function () {
                ...
                return img.onload = function () {
                    ...
                    for (i = _i = 0, _len = data.length; _i < _len; i = _i += 4) {
                        ...
                        _this.mapData[row].push([Number(data[i]).toHex(), Number(data[i + 1]).toHex(),
                            Number(data[i + 2]).toHex(), Number(data[i + 3]).toHex()]);
                    }
        ...
        Map = (function () {
            function Map(_arg) {
                this.sprite = _arg.sprite, this.read = _arg.read, this.pattern = _arg.pattern, this.movement =
                    _arg.movement, this.tilePlacement = _arg.tilePlacement, this.mapFile = _arg.mapFile, this.ed =
                    _arg.ed;
        ...
        {"./datasource.coffee": 8, "./movementrules.coffee": 10, "./placementstrategy.coffee": 11, "./readstrategy.coffee": 12}], 10: [function (_dereq_,
                                                                                                                                                 module,
                                                                                                                                                 exports) {
        var MovementRules;
        ...
        ReadStrategy = (function () {
            ...
            ReadStrategy.prototype.readSimple = function (mapData, sprite) {
                ...
                tiles = [];
                for (row = _i = 0, _ref = mapData.height - 1; 0 <= _ref ? _i <= _ref : _i >= _ref;
                     row = 0 <= _ref ? ++_i : --_i) {
                    for (col = _j = 0, _ref1 = mapData.width - 1; 0 <= _ref1 ? _j <= _ref1 : _j >= _ref1;
                         col = 0 <= _ref1 ? ++_j : --_j) {
                        tiles.push(new Tile({
                            sprite: sprite,
                            data: {
            ...
            ReadStrategy.prototype.readSquare = function (mapData, sprite) {
                var col, row, tiles, _i, _j, _ref, _ref1;
                tiles = [];
                for (row = _i = 0, _ref = mapData.height - 2; 0 <= _ref ? _i <= _ref : _i >= _ref;
                     row = 0 <= _ref ? ++_i : --_i) {
                    for (col = _j = 0, _ref1 = mapData.width - 2; 0 <= _ref1 ? _j <= _ref1 : _j >= _ref1;
                         col = 0 <= _ref1 ? ++_j : --_j) {
                        tiles.push(new Tile({
                            sprite: sprite,
                            data: {
                                col: col,
                                row: row,
                                type: "" + mapData[row][col][0] + mapData[row][col + 1][0] + mapData[row + 1][col][0] +
                                    mapData[row + 1][col + 1][0],
                                walkable: parseInt(mapData[row][col][1], 16),
                                z: parseInt(mapData[row][col][2], 16)
                            },
                            map: this.map
                        ...
                        if (mapData[row][col][0] !== "00") {
                            tiles.push(new Tile({
                                ...
                                data: {
                                    col: col,
                                    row: row,
                                    type: "" + mapData[row - 1][col][0] + mapData[row][col + 1][0] +
                                        mapData[row + 1][col][0] + mapData[row][col - 1][0],
                                    walkable: parseInt(mapData[row][col][1], 16),
                                    z: parseInt(mapData[row][col][2], 16)
                                },
                                map: this.map
        ...
        Tile = (function () {
            function Tile(_arg) {
                ...
                this.bb = new BoundingBox(new Vector(this.x, this.y),
                    new Vector(this.sprite.innerWidth, this.sprite.innerHeight));
        ...
        SceneManager = (function () {
            ...
            SceneManager.prototype.setScene = function (scene, parent) {
                ...
                return this.currentScene =
                        (_base = this.scenes[scene]).instance != null ? (_base = this.scenes[scene]).instance :
                    _base.instance = new this.scenes[scene]["class"](parent);
            };
        ...
        Shape = (function () {
            ...
            Shape.prototype.render = function (ctx) {
                ...
                ctx.drawImage(this.sprite.texture, this.sx, this.sy, this.sprite.width, this.sprite.height, 0, 0,
